...
// No real social/Google Business Profile URLs were supplied yet.
// These are intentionally obvious placeholders — swap each one for the
// real URL when available; nothing else in the codebase needs to change.
export const SOCIAL = {
  facebook: "https://facebook.com/PLACEHOLDER_UPDATE_ME",
  instagram: "https://instagram.com/PLACEHOLDER_UPDATE_ME",
  twitter: "https://twitter.com/PLACEHOLDER_UPDATE_ME",
  linkedin: "https://linkedin.com/company/PLACEHOLDER_UPDATE_ME",
  youtube: "https://youtube.com/@PLACEHOLDER_UPDATE_ME",
  googleBusinessProfile: "https://g.page/PLACEHOLDER_UPDATE_ME",
};
...
const DEFAULT_OG_IMAGE = "/website-assets/Process_banner.png";
